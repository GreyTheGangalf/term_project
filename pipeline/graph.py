...
from pipeline.agents import macro_agent_node, fundamental_agent_node, portfolio_manager_node
...
workflow.add_edge("fundamental_agent", "portfolio_manager") 
workflow.add_edge("portfolio_manager", END) 

app = workflow.compile()

if __name__ == "__main__":
    print("=== LANGGRAPH PIPELINE TESTİ BAŞLIYOR ===")
